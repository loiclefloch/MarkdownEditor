...
class MarkdownHighlighter(QSyntaxHighlighter):
    ...
    def __init__(self, parent=None, theme=None):
        ...
        if theme:
            self.h1_color               = theme["h1"]
            self.h2_color               = theme["h2"]
            self.h3_color               = theme["h3"]
            self.h4_color               = theme["h4"]
            self.h5_color               = theme["h5"]
            self.h6_color               = theme["h6"]
            self.bold_color             = theme["bold"]
            self.italic_color           = theme["italic"]
            self.link_color             = theme["link"]
            self.code_color             = theme["code"]
            self.anchor_color           = theme["anchor"]
            self.block_quotes_color     = theme["quotes"]
            self.html_entity_color      = theme["html"]
